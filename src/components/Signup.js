...
import { signup } from '../rtk/slices/actions/auth';
...
const Signup = ({ signup, isAuthenticated }) => {
    ...
    return (
        <div className='container mt-5'id="signup">
            ...
            <p className="log">Create your Account</p>
            <form onSubmit={e => onSubmit(e)}>
                ...
                <button className='btn btn-primary but'  style={{ backgroundColor: "#312450" }} type='submit'>Register</button>
            </form>
